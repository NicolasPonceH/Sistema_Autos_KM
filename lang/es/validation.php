...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Nombres de atributos del dominio
    |--------------------------------------------------------------------------
    */

    'attributes' => [
        'patente' => 'patente',
        'tipo_codigo' => 'tipo de vehículo',
        'marca' => 'marca',
        'modelo' => 'modelo',
        'anio' => 'año',
        ...
        'es_correccion' => 'corrección',
        'confirmar_salto' => 'confirmación de salto',
        'nombre' => 'nombre',
        'intervalo_km' => 'intervalo (km)',
        'umbral_aviso' => 'umbral de aviso',
        'intervalo_meses' => 'intervalo (meses)',
        'umbral_aviso_dias' => 'umbral de aviso (días)',
        'plan_id' => 'plan de mantención',
        'km_evento' => 'kilometraje del servicio',
        'fecha' => 'fecha',
        'costo' => 'costo',
        'taller' => 'taller',
        'notas' => 'notas',
